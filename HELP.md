...
* The original package name 'com.example.event management app' is invalid and this project uses 'com.example.event.management.app' instead.
...
* [Getting Started with Distributed Tracing](https://docs.spring.io/spring-boot/3.3.8/reference/actuator/tracing.html)
